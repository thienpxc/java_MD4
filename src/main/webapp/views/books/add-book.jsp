...
<form action="/books?action=ADD"  method="post" >
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" name="price" id="price" placeholder=" name...">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" name="totalPages" id="totalPages" placeholder="TotalPages...">
    </div>
    <div class="mb-3">
        <label for="yearCrated" class="form-label">yearCrated</label>
        <input type="number" class="form-control" name="yearCrated" id="yearCrated" placeholder="yearCrated...">
    </div>
    <div class="mb-3">
    ...
    <input type="submit" name="action" value="ADD" class="btn btn-primary" onclick="return alert('da them thanh cong')"/>
